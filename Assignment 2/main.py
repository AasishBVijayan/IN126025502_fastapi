...
# ══ ENDPOINTS ═════════════════════════════════════════════════════
# ROUTE ORDER RULE:
# Fixed routes must come BEFORE variable routes
...
# ── Path Parameter (must come AFTER fixed routes) ──────────────────
...
@app.post('/feedback')
def submit_feedback(data:OrderRequest):
    feedback.append(data.dict())
    return {'message': 'Feedback received', 'feedback': data.dict(), 'total_feedback': len(feedback)}
